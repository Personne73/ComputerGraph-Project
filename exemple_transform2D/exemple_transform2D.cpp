...
struct Application
{
    ...
    void Initialize()
    {
        m_basicProgram.LoadVertexShader("transform330.vs.glsl");
        m_basicProgram.LoadFragmentShader("basic330.fs.glsl");
...
// g++ -o exemple_transform2D exemple_transform2D.cpp common/GLShader.cpp -lglfw3 -lGL -lGLEW -lX11 -lpthread -lXrandr -lXi -ldl
// ./exemple_transform2D